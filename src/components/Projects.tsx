...
function Projects({}: Props) {
  ...
  return (
    <motion.div initial={{opacity: 0,}} whileInView={{opacity: 1,}} transition={{duration: 1.5,}}
      className='pageDiv overflow-hidden md:fr max-w-full z-0'>
      <h3 className='titleStyle'>Projects</h3>
      <div className='rela f w-full overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollBar'>
        {projs.map((proj, i) => (
          <div className='h-screen w-screen fs0 ficjc fc p-20 md:p-44 space-y-5 snap-center'>
            {/* motion.img 2:06:17 */}
